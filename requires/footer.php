            ...
            <footer>
                ...
                <div class="contacts">
                    ...
                    <ul class="footer_list_container">
                          ...
                          <li><a href="https:www.instagram.com/design_with_rob"><i class="fa fa-instagram" alt=""></i>&nbsp; instagram.com/design_with_rob</a></li>
                    </ul>
                </div>
                <div class="site_map">
                <h4>Links</h4><br>
        ...
        <span>
            ...
            <form id="comment_form" action="user_request.php" method="get" >
                ...
                <div>
                    ...
                    <input type="number" min="1970" max="2021" name="year" id="year"/>
                </div>

                <div>
                    <label for="publish_info">Edition</label>
                    <input type="number" min="0" max="10" name="edition" id="edition" />
                </div>
                ...
                <div class="form_btn">
                    ...
                    <button type="reset" id="form_cancel" name="cancel">CANCEL</button>
                </div>
            </form>
